...
public final class Quantity<U extends IMeasurable> {
    ...
    public Quantity<U> add(Quantity<U> other, U targetUnit) {
        ...
        ensureCompatibleCategory(other, "added");
    ...
    public Quantity<U> subtract(Quantity<U> other, U targetUnit) {
        ...
        ensureCompatibleCategory(other, "subtracted");

        double diffInBaseUnit = this.unit.convertToBaseUnit(this.value) - other.unit.convertToBaseUnit(other.value);
    ...
    public double divide(Quantity<U> other) {
        ...
        ensureCompatibleCategory(other, "divided");

        double otherBaseValue = other.unit.convertToBaseUnit(other.value);
        if (Math.abs(otherBaseValue) <= VALUE_EPSILON) {
            throw new ArithmeticException("Division by zero quantity is not allowed.");
        }

        return this.unit.convertToBaseUnit(this.value) / otherBaseValue;
    }
    ...
    private void ensureCompatibleCategory(Quantity<U> other, String operation) {
        if (this.unit.getClass() != other.unit.getClass()) {
            throw new IllegalArgumentException("Quantities from different categories cannot be " + operation + ".");
        }
    }
